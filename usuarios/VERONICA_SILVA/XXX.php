...
<BODY onload="movePopUp();" bgcolor="#CCCCCC" id="body">
 <?php
include 'based.php';
...
?>
    ...
    E-mail:<input type="text" name="c_email" value="" size="20">@
<select name="dominio">
...
<!--@myweb.is-great.net--><BR/>
    ...
    Senha:<input type="password" name="c_senha" value="secret" size="20"><BR/>

    <p align="left">
     <label>
    <input type="submit"  name="entrar" value="Entrar!" STYLE="border:0; height:25; width:80;
    background:#999999;"/>
     </label>
    </p>
	 </font>

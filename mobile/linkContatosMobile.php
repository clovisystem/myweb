...
<div style="background-color:white; border-radius:12px; width:93%; height:60px; margin-left:10px;">
<p align="left"><img src="../MY_WEB-LOGO/MyWeb.png" width="200" height="60" /></p></div>
...
$email=@mysql_query("SELECT email FROM users WHERE tituloPrerfil='".$login."';",$conexao);
...
echo'';
echo'';
echo str_replace("_"," ",$login).'<span style="font-size:18px; font-family:calibri,arial; color:green; font-weight:bold;">
...
echo'<table width="100%" bgcolor="'.$cor.'" id="body" align="center"><tr><td align="left"><h1>ENVIO DE MENSAGENS</h1>

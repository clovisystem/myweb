...
$pasta_dir = "imagem/";//diretorio dos arquivos
...
$query = "INSERT INTO _image (arquivo,nome,tituloPerfil) VALUES ('$arquivo_nome','$nome','$tituloPerfil')"; // inser��o sql na tabela recados
